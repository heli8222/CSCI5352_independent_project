...
# Code file 0a
# 0_niche.R
# previously written code for generating a synthetic food web using the niche model
...
#-----------------------------------------------------------------------------#
# make_nm_web(): master function that generates niche model network
...
make_nm_web <- function(S, B, C) {
  ...
  #---------------------------------------------------------------------------#
  # comment out this section while running niche validation.R to speed up web generation process
